...
byte ub = 2;                            // Ubicación (1-despacho) (2-aseo) (3-dormitorio) (4-salón) (5-pruebas).
...
IPAddress dns(192, 168, 1, 9);          // DNS primario, en mi caso es un servidor DNS local. Se pueden usar los de google 8.8.8.8 y otros.
...
//Configuración para MQTT. Pon el usuario y constraseña de tu instalación
const char* usuario = "****";
const char* pass = "****";
...
const char* publicar = "casa/aseo/variables";
