...
//Configuración para mostrar pantalla en base al ventilador.
byte ventilador = 0;
...
int mostrar = 4; // 1-despacho 2-aseo 3-dormitorio 4-salón 5-pruebas
...
char * passwordOTA = "****";      // Pon la contraseña que desees para las actualizaciones via OTA

//Configuración para MQTT//
const char* usuario = "****"; // Pon el usuario de tu servidor MQTT
const char* pass = "****";    // Pon la contraseña de tu servidor MQTT

const IPAddress MQTT_HOST(192,168,1,9); // pon la IP de tu servidor MQTT
const int MQTT_PORT = 1883;

const char* publicar1 = "casa/despacho/variables";
const char* publicar2 = "casa/salon/ventilador";
const char* publicar3 = "casa/dormitorio/ventilador";

const char*  suscribir1 = "casa/salon/variables";
