...
void btn5_pressAction(void)
{
  if (mostrar == 3){
    ventilador = 1;
    if (btn5.justPressed()) btn5.drawSmoothButton(true);
  }
  if (mostrar == 1){
    ventilador = 2;
    if (btn5.justPressed()) btn5.drawSmoothButton(true);
...
void initButtons() {
  ...
  btn1.initButtonUL(x, y, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Salon", 1);
  ...
  btn2.initButtonUL(x, y, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Aseo", 1);
  ...
  btn3.initButtonUL(x, y, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Dormi", 1);
  ...
  x = (tft.width() - BUTTON_W) / 2 - 180;
  btn4.initButtonUL(x, y, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Despa", 1);
  ...
  btn5.initButtonUL(x, y1, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Venti", 1);
  ...
  x = (tft.width() - BUTTON_W) / 2 - 160;
  btn6.initButtonUL(x, y1, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "A/A", 1);
...
void configuracionPantalla(){
  ...
  tft.setRotation(1);	                                        // establece posicion 0 - vertical alimentación arriba, 1-horizontal alimentación izquierda, 2-vertical alimentación abajo, 3-horizontal alimentación derecha.
  tft.fillScreen(TFT_BLACK);                                  // Establece el fondo de pantalla.
...
void drawReloj(int x, int y){
  ...
  int xpo = (RWIDTH / 2);
  img.setTextColor(TFT_LIGHTGREY, TFT_BLACK, true);
