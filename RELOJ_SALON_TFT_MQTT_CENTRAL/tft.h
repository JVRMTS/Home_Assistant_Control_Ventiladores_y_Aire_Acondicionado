...
void initButtons() {
  ...
  btn1.initButtonUL(x, y, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Despa", 1);
  ...
  x = (tft.width() - BUTTON_W) / 2 - 180;
  btn4.initButtonUL(x, y, BUTTON_W, BUTTON_H, TFT_WHITE, TFT_DARKGREY, TFT_BLACK, "Salon", 1);
